                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <form action="/manajemen_admin/user/{{ $users[0]->id }}" method="POST" id="form">
                                    <input type="hidden" name="hidden_username" value="{{ $users[0]->username }}" readonly>
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        <label for="name">Nama Lengkap</label>
                                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror"
                                            placeholder="name" name="name" autofocus value="{{ old('name',$users[0]->name) }}" autocomplete="off">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="username" class="form-control @error('username') is-invalid @enderror"
                                            placeholder="Username" name="username" value="{{ old('username',$users[0]->username) }}" autocomplete="off">
                                        @error('username')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            placeholder="Email" name="email" value="{{ old('email',$users[0]->email) }}" autocomplete="off">
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_role" id="id_role" class="form-control @error('id_role') is-invalid @enderror">
                                            ...
                                            @foreach($roles as $role)
                                                @if(old('id_role',$users[0]->id_role) == $role->id)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            placeholder="YYYY-MM-DD" name="tanggallahir" value="{{ old('tanggallahir',$users[0]->tanggallahir) }}" autocomplete="off">
                                            @error('tanggallahir')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
